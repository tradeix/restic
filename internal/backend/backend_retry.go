...
func (be *RetryBackend) Save(ctx context.Context, h file.Handle, rd restic.RewindReader) error {
...
func (be *RetryBackend) Load(ctx context.Context, h file.Handle, length int, offset int64, consumer func(rd io.Reader) error) (err error) {
...
func (be *RetryBackend) Stat(ctx context.Context, h file.Handle) (fi restic.FileInfo, err error) {
...
func (be *RetryBackend) Remove(ctx context.Context, h file.Handle) (err error) {
...
func (be *RetryBackend) Test(ctx context.Context, h file.Handle) (exists bool, err error) {
...
// caller.
func (be *RetryBackend) List(ctx context.Context, t file.FileType, fn func(restic.FileInfo) error) error {
